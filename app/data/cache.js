...
/**
 * @param {{loaderHeaders: Headers}}
 */
export function routeHeaders({ loaderHeaders }) {
...
export const CACHE_LONG = generateCacheControlHeader(
  CacheLong(),
)
export const CACHE_NONE = generateCacheControlHeader(
  CacheNone(),
)
